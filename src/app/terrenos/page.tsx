...
const statusColor: Record<Terrain['status'], string> = {
  pipeline: 'bg-suelo text-tierra border-arena/30',
  evaluated: 'bg-suelo/50 text-musgo border-arena/30',
  rejected: 'bg-ceibo/5 text-ceibo border-ceibo/20',
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-8 py-10">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-normal text-ink">Terrenos</h1>
                ...
                <div key={t.slug} className="border border-suelo rounded-xl overflow-hidden">
                  ...
                  <div className="px-5 py-3 border-t border-suelo flex justify-end">
                    <Link
                      ...
                      className="text-xs text-musgo hover:text-musgo transition-colors">
                      Analizar con Brain →
                    </Link>
                  </div>
                </div>
